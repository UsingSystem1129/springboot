...
<head>
    ...
    <link href="${base}/static/font-awesome/${base}/static/css/font-awesome.css" rel="stylesheet">

    <link href="${base}/static/css/plugins/dataTables/datatables.min.css" rel="stylesheet">
...
<body>
    ...
    <script src="${base}/static/js/plugins/jeditable/jquery.jeditable.js"></script>

    <script src="${base}/static/js/plugins/dataTables/datatables.min.js"></script>
