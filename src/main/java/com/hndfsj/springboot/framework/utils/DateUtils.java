...
public class DateUtils {
	...
	public static final String DATETIME_YMDHMS_SHORT_FORMAT = "yyMMddHHmmss";
	...
	public static String formatDateTime(Date d) {
		return d == null ? null : new SimpleDateFormat(DATETIME_MINUTE_FORMAT).format(d);
	}
	...
	public static int getMonthsBetween(Date beginDate, Date endDate) {
		...
		return getMonthsBetween(begin, end);
	}

	public static int getMonthsBetween(Calendar beginDate, Calendar endDate) {
		if (beginDate.after(endDate)) {
			Calendar swap = beginDate;
			beginDate = endDate;
			endDate = swap;
		}
		int year = endDate.get(Calendar.YEAR) - beginDate.get(Calendar.YEAR);
		return year * 12 + endDate.get(Calendar.MONTH) - beginDate.get(Calendar.MONTH) + 1;
	}
	...
	*/
	...
	public static List<String> getBetweenDatesToString(Date start, Date end,SimpleDateFormat dateFormat
			) {
