...
public class MessageUtils {
	...
	public static final String UNLOGIN = ResourceUtils.getString("unlogin");// 会话失效
	...
	public static final String OPERA_SUCCESS = ResourceUtils.getString("opera_success");// 操作成功
	public static final String OPERA_FAIL = ResourceUtils.getString("opera_fail");// 操作失败

	public static final String AUTH_FAIL = ResourceUtils.getString("auth_failure");// 认证失败

	public static final String EDIT_SUCCESS = ResourceUtils.getString("edit_success");// 数据修改成功
	public static final String EDIT_WARING = ResourceUtils.getString("edit_warning");// 数据修改异常
	...
	public static final String ROLE_ASSIGN_MANAGER_ISEXIST = ResourceUtils.getString("role_assign_manager_isexist");// 主管角色已经存在
	...
	public static final String WELCOMEMESSAGE = ResourceUtils.getString("sms_welcome_message");// 短信欢迎语

	// 系统相关提示
	public static final String SERVER_BUSY = "服务器繁忙";

	// 验证字段在数据库中是否存在
	public static String VALUE_ISEXIST = "已存在";
	public static final String VALUE_NOTEXIST = "不存在";

	// 用户操作错误类型提示
	public static final String OPERATING_PARAMETERS_ERROR = "参数非法";

	// 用户注册提示信息
	public static final String USER_REALNAME_ISNOTNULL = "姓名不能为空";
	public static final String USER_REALNAME_ISNOTCHINE = "姓名必须为中文";
	// 验证公共提示字段
	public static final String VALIDATE_IS_NOT_NULL = "不能为空";

	public static final String VALUE_ISNULL = "值是NULL";
	public static final String NO_AUTHORITY = "没有该操作权限";
