...
public class TranscodeUtil {
	...
	/**
	 * 
	 * 将ISO-8859-1编码的字符串转化为GB18030编码的字符串
	 * 
	 * @param ISO8859_1
	 * @return
	 * @author Mr.Hao
	 */
	public static String GB18030FromISO8859_1(String ISO8859_1) {
		if (StringUtils.isBlank(ISO8859_1)) {
			return "";
		} else {
			try {
				return new String(ISO8859_1.getBytes("ISO-8859-1"), "GB18030");
			} catch (Exception e) {
				e.printStackTrace();
				return null;
			}
	...
	/**
	 * 
	 * 将GB18030编码的字符串转化为ISO-8859-1编码的字符串
	 * 
	 * @param GB18030
	 * @return
	 * @author Mr.Hao
	 */
	public static String ISO8859_1FromGB18030(String GB18030) {
		if (StringUtils.isBlank(GB18030)) {
			return "";
		} else {
			try {
				return new String(GB18030.getBytes("GB18030"), "ISO-8859-1");
			} catch (Exception e) {
				e.printStackTrace();
				return null;
			}
